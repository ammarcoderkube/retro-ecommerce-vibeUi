...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-zinc-900/80 p-1 text-muted-foreground border border-border/60",
      className
    )}
    {...props}
  />
